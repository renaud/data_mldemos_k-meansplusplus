...
legendString = {['k-means (n=200'],	['k-means++ (n=200)']};

xBins = 7:0.5:40;          					% Bin positions will be 0.5 apart
...
stairs(x_km, n_km/sum(n_km), 'k');          % km is black
stairs(x_kmp, n_kmp/sum(n_kmp), 'r');
